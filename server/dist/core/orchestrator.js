...
import { validateInputs, calculateBreakEven, inferVariableCosts, calculateDistributableSurplus, calculateWeights, distributeSurplus, allocateLaborSurplus, auditSystem, generateCertificate, } from "./steps.js";
export function runExcedentesEngine(input) {
    ...
    const employeeSurplusLedger = allocateLaborSurplus(distribution.laborSurplusPool, input.employees);
